...
Or two literals of Uint type:

>>> res = U(1) | U(2)


Or two literals of Sint type:

>>> res = S(1) | S(2)


Or two wires of Uint type:

>>> w1 = Wire(U.w(8)); w2 = Wire(U.w(9))
>>> res = w1 | w2


Or two wires of Vector type:

>>> w1 = Wire(U.w(8)[8]); w2 = Wire(U.w(9)[8])
>>> res = w1 | w2


Or two wires of Bundle type:
...
def _(lf, rt):
    ...
    t = UIntT(w)
    return ExprHolder(t, VariableType.ReadOnly, Or(lf, rt))
