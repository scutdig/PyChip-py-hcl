...
from py_hcl.firrtl_ir.type_checker import check, AccessorTypeChecker
...
def test_sub_field_basis():
    ...
    assert AccessorTypeChecker.check(sf)
    assert check(sf)
...
def test_sub_field_non_exist():
    ...
    assert not AccessorTypeChecker.check(sf)
    assert not check(sf)
...
def test_sub_index_basis():
    ...
    assert AccessorTypeChecker.check(si)
    assert check(si)
...
def test_sub_index_over_bound():
    ...
    assert not AccessorTypeChecker.check(si)
    assert not check(si)
...
def test_sub_access_basis():
    ...
    assert AccessorTypeChecker.check(sa)
    assert check(sa)
...
def test_sub_access_non_vector():
    ...
    assert not AccessorTypeChecker.check(sa)
    assert not check(sa)
